...
class ConversationProcessorAgentTester:
    """对话内容处理智能体测试类"""

    def __init__(self, base_url: str = "http://localhost:8000"):
        self.base_url = base_url
        self.api_endpoint = f"{base_url}/conversationprocessor/process-conversation"
        self.test_results: List[Dict[str, Any]] = []

    def load_test_data(self, file_path: str, limit: int = 5000) -> List[Dict[str, str]]:
        """
        加载测试数据
    ...
    async def run_all_tests(self, data_file_path: str, limit: int = 500) -> List[Dict[str, Any]]:
        ...
        :return: 所有测试结果
        """
        logger.info("开始ConversationProcessorAgent测试")
        ...
        logger.info("ConversationProcessorAgent测试完成")
...
async def main():
    """主测试函数"""
    tester = ConversationProcessorAgentTester()
    
    # 运行测试
    data_file = r"D:\PycharmProjects\zc_project\agents_system\data\jianlian.json"
    results = await tester.run_all_tests(data_file, limit=1000)
    
    # 保存结果
    output_file = r"D:\PycharmProjects\zc_project\agents_system\data\output\conversation_processor_test_results.json"
